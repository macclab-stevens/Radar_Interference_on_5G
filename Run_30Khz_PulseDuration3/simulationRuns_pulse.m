...
simParametersBase.folderName = 'Run_30Khz_PulseDuration3/';
...
parfor i = 1:numSimulations
    ...
    simParameters.prf = ttiPairs(i, 3);
    simParameters.PulseWidth = ttiPairs(i, 2);%50 * 1e-6;
    ...
    simParameters.PulseBW = 1e6;
    simParameters.PulseBWoffset = 9.5e6;

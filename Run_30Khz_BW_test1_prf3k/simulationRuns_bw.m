...
simParametersBase.folderName = 'Run_30Khz_BW_test1_prf3k/';
...
PulsePowerAtten = 0:-2:-70;

P_BW = (.1:.1:30)*1e6
% Create all combinations of TTI and radarBWoffset
[ttiGrid, P_BWGrid] = ndgrid(ttis, P_BW);
ttiPairs = [ttiGrid(:), P_BWGrid(:)]
...
parfor i = 1:numSimulations
    ...
    simParameters.prf = 3000;%ttiPairs(i, 2);

...
[ttiGrid, P_BWGrid,prf_stepsGrid] = ndgrid(ttis, P_BW,prf_steps);
ttiPairs = [ttiGrid(:), P_BWGrid(:),prf_stepsGrid(:)]
...
parfor i = 1:numSimulations
    ...
    simParameters.prf =  ttiPairs(i, 3);%ttiPairs(i, 2);

classdef hNRSchedulerStaticMCS < hNRScheduler
    %hNRSchedulerStaticMCS Implements round-robin scheduler

    %   Copyright 2020 The MathWorks, Inc.

    methods
        function obj = hNRSchedulerStaticMCS(simParameters)
            %hNRSchedulerStaticMCS Construct an instance of this class
